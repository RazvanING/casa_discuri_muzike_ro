                        ...
                        <form action="DeletePost.php?Delete=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">
                            <fieldset>
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo $TitleToBeUpdated; ?>" class="form-control" type="text" name="Title" id="title" placeholder="Name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled type="file" class="form-control" name="Sample" id="sampleSelect" accept=".mp3">
